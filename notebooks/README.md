...
| 15 | `15_fakenewsnet_subpart_transfer_tfidf.py` | Within-FakeNewsNet subpart transfer (PolitiFact vs GossipCop), TF-IDF baseline |
| 16 | `16_fnn_subpart_transfer_roberta.py` | Within-FakeNewsNet subpart transfer, weighted RoBERTa |
