...
| Dissertation draft update | 2026-05-25 | 2026-05-28 | Update Chapter 6, Discussion, Conclusion, figures, tables, and layout | Completed | `thesis_writeup/dissertation_current.docx` |
| Meeting preparation | 2026-05-29 | 2026-05-29 | Prepare pre-meeting update | Completed | `progress/progress_update_2026-05-29.md` |
| Requested titles-only rerun | 2026-05-29 | 2026-05-30 | Re-run held-out titles-only direct transfer with seeds 42/52/62/72/82 and report mean/std | Completed | `results/intermediate_finetuning/titles_only_direct_transfer_heldout_5seed_summary_20260530.md` |
| Requested intermediate FT reruns | 2026-05-30 | 2026-05-30 | Re-run 10% and 20% target fractions with the same five seeds and update integrated table | Completed | `results/intermediate_finetuning/intermediate_ft_10pct_5seed_summary_20260530.md`; `results/intermediate_finetuning/intermediate_ft_20pct_5seed_summary_20260530.md` |
| LIAR vs FakeNewsNet dataset-shift analysis | 2026-05-30 | 2026-05-30 | Analyse length, vocabulary overlap, dataset-distinctive terms, and label-distinctive terms | Completed | `results/dataset_shift_analysis/liar_vs_fakenewsnet_explanation_20260530.md` |
| Review reading package | 2026-05-30 | 2026-05-30 | Prepare Chapter 2/3 reading package | Completed | `thesis_writeup/review_materials_20260530/ch2_ch3_results_2026-05-30.md` |

## Current main decision

The dissertation should be framed around reproducible baselines, strict transfer failure, and target-domain fine-tuning recovery. The 10% setting is the more data-efficient stable recovery point, while the 20% setting is currently the strongest absolute five-seed target-fraction result. The TELLER-like pilot is supporting analysis only and should be described as current DeepSeek V4 Flash reasoning-atom setup evidence with limited performance in this pilot.
